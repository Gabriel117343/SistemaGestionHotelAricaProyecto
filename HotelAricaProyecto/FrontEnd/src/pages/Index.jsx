  ...
  return (
    <>
      <header>
        <Navbar />
        <div>
          <ImageGallery class="galeria" items={images} showPlayButton={false} showFullscreenButton={false} showThumbnails={false} showNav={false} showBullets={true} autoPlay={true}/>
